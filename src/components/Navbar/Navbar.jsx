...
const Navbar = ({ userProfilePicture = images.userProfilePicture, searchInputPlaceholder = texts.searchInputPlaceholder }) => {
  return (
    <div className="relative flex justify-center p-[0px] box-border">
      <div className=" w-full min-h-[80px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-between items-center content-space-between p-[16px_16px_16px__16px] bg-[#000000ff] box-border border-l-[1px] border-l-[#f2f2f266] border-r-[0px] border-r-[#f2f2f266] border-t-[0px] border-t-[#f2f2f266] border-b-[0px] border-b-[#f2f2f266]">
        {/* Search1 */}
